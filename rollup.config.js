...
const standaloneBaseConfig = {
  ...
  input: './src/index.js',
  output: {
    file: 'dist/react-native-hooks-async-storage.js',
    format: 'umd',
    globals,
    name: 'react-native-hooks-async-storage',
    sourcemap: true,
  },
...
const standaloneProdConfig = {
  ...
  output: {
    ...
    file: 'dist/react-native-hooks-async-storage.min.js',
  },
...
const nativeConfig = {
  ...
  output: [
    getCJS({
      file: 'dist/react-native-hooks-async-storage.cjs.js',
    }),
    getESM({
      file: 'dist/react-native-hooks-async-storage.esm.js',
    }),
  ],
};
